...
function play() {
	...
	reader.onload = function(event) {
		...
		for (var i = 0; i < tracks.length; i++) {
			player.loader.startLoad(audioCtx, "https://surikov.github.io/webaudiofontdata/sound/" + audioLib(instrDict[tracks[i]["Instrument"]]) + ".js", "_tone_" + audioLib(instrDict[tracks[i]["Instrument"]]));
			player.loader.waitLoad(function(){});
		}
